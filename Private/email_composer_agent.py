...
from Private.ai_philosophy_agent import SovereigntyPhilosophyAgent
...
"""
    ...
    def send_email(self, email_package, test_mode=False):
        """
...
def main():
    ...
    try:
        ...
        username = "test3"
        test_email = "dmh4681@gmail.com"  # Replace with real email for testing
        ...
        if email_package and "error" not in email_package:
            ...
            print(f"\n📤 Testing email send...")
            send_result = agent.send_email(email_package, test_mode=False)
